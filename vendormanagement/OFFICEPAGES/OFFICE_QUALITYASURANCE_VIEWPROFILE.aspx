<%@ Page Language="C#" MasterPageFile="~/OFFICEPAGES/OFFICEMASTER_QUALITYASURANCE.master" AutoEventWireup="true" CodeFile="OFFICE_QUALITYASURANCE_VIEWPROFILE.aspx.cs" Inherits="OFFICEPAGES_OFFICE_QUALITYASURANCE_CREATEPROFILE" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    <table style="left: 167px; position: relative;
        top: 5px">
        <tr>
        ...
        <tr>
            ...
            <td style="font-size: 12pt; width: 146px; height: 25px;">
            ...
            <td style="font-size: 12pt; width: 173px; height: 25px;">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TXTOFFCONMOB"
                    ErrorMessage="Nember Must Be 10 Digits" Font-Bold="True" Style="position: relative"
