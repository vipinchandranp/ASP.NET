<%@ Page Language="C#" MasterPageFile="~/OFFICEPAGES/OFFICEMASTER_PURCHASEORDER.master" AutoEventWireup="true" CodeFile="OFFICE_PURCHASEORDER_VIEWPROFILE.aspx.cs" Inherits="OFFICEPAGES_OFFICE_PURCHASEORDER_CREATEPROFILE" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<table
        style="left: 167px; position: relative; top: 5px">
        <tr>
        ...
        <tr style="font-size: 12pt">
            ...
            <td style="width: 146px">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Not A Valid Email-Id"
                    Font-Bold="True" Style="position: relative" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator></td>
            <td style="width: 173px">
            </td>
        </tr>
        <tr style="font-size: 12pt">
